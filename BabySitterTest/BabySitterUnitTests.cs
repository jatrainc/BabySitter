...
using System;
using BabySitter.Calculator;
using BabySitter.Validators;
namespace BabySitterTest
{
    public class Tests
    {
        private BabySitter.Customer.FamilyA _familyA;
        private BabySitter.Customer.FamilyB _familyB;
        private BabySitter.Customer.FamilyC _familyC;
        [SetUp]
        public void Setup()
        {
            _familyA = new BabySitter.Customer.FamilyA();
            _familyB = new BabySitter.Customer.FamilyB();
            _familyC = new BabySitter.Customer.FamilyC();
        }
